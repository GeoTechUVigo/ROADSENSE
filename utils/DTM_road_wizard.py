...
def DTM_road_generator(road,road_type,ORIGINAL_SEGMENTS,scale,number_points_DTM,road_buffer,slope_buffer,shoulder_buffer,berm_buffer,noise_DTM,noise_road,noise_slope,noise_shoulder,noise_berm,noise_refugee_island):
    """
...
# surface in which some trees can fit.
    ...
    else: # Not road presence in the point cloud
